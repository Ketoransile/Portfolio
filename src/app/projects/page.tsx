  ...
  return (
    <>
      <div className="min-h-screen relative bg-black-100 flex items-center flex-col overflow-hidden mx-auto sm:px-10 px-5 max-lg:pb-20">
        ...
        <div className="h-screen w-full dark:bg-black-100 bg-white dark:bg-grid-white/[0.6] bg-grid-black/[0.2] flex items-center justify-center absolute top-0 left-0">
          <div className="h-full absolute pointer-events-none inset-0 flex items-center justify-center dark:bg-black bg-white [mask-image:radial-gradient(ellipse_at_center,transparent_20%,black)]" />
        </div>
        <TextGenerateEffect
          className="max-md:text-xl md:text-3xl lg:text-4xl pt-12 pb-0"
          words="Things I've Built"
